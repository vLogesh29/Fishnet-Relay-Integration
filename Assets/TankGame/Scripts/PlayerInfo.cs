...
namespace EOSLobbyTest
{
    public class PlayerInfo : NetworkBehaviour
    {
        ...
        public override void OnStartServer()
        {
            ...
            UserId = EOSUpgrade.FishyEOS_GetRemoteConnectionAddress(Owner.ClientId);
#endif
        }
        ...
        private void CleanUpEOSandVivox()
        {
            ...
            if (IsOwner)
            {
                ...
                if (EOSUpgrade.GetCachedLobbyInterface() != null)
                {
        ...
        public override void OnStopServer()
        {
            ...
            if (EOSUpgrade.GetCachedLobbyInterface() != null)
            {
                ...
                EOSUpgrade.GetCachedLobbyInterface().KickMember(ref kickMemberOptions, null, delegate (ref KickMemberCallbackInfo data)
                {
                    // as we have a bit of a race condition depending whether the server kicks or we leave
                    // just report the failure as a normal log
                    if (data.ResultCode != Result.Success)
