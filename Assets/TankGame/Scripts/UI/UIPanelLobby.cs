...
namespace EOSLobbyTest
{
    public class UIPanelLobby : UIPanel<UIPanelLobby>, IUIPanel
    {
        ...
        private void JoinLobby()
        {
            ...
            EOSUpgrade.GetCachedLobbyInterface().JoinLobbyById(ref joinOptions, null, delegate (ref JoinLobbyByIdCallbackInfo data)
            {
        ...
        private void CreateLobby()
        {
            ...
            EOSUpgrade.GetCachedLobbyInterface().CreateLobby(ref options, null,
                delegate (ref CreateLobbyCallbackInfo data)
                {
                    ...
                    EOSUpgrade.GetCachedLobbyInterface().UpdateLobbyModification(ref updateLobbyModificationOptions, out lobbyModification);
                    ...
                    EOSUpgrade.GetCachedLobbyInterface().UpdateLobby(ref updateLobbyOptions, null, delegate (ref UpdateLobbyCallbackInfo updateData)
                    {
        ...
        private void LeaveLobby()
        {
            ...
            if (!string.IsNullOrEmpty(LobbyId))
            {
                ...
                EOSUpgrade.GetCachedLobbyInterface().LeaveLobby(ref updateLobbyModificationOptions, null, delegate (ref LeaveLobbyCallbackInfo data)
                {
                    if (data.ResultCode != Result.Success)
                    {
