...
namespace Alter.Runtime.Character.Animim
{
    ...
    public class AnimimGraph
    {
        ...
        [NonSerialized] private ICharacter m_Character;
        ...
        internal ICharacter Character => this.m_Character;
        ...
        public void OnStartup(ICharacter character)
        {
            ...
            this.CreateGraph(this.m_Character.CharacterAnimation.animator);
            this.m_Phases.Setup(this.m_Character.CharacterAnimation.animator);
        ...
        public void CreateGraph(Animator animator)
        {
            if (animator == null)
            {
